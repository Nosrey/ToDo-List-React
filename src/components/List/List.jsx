    ...
    return (
        <div className={'bg-black w-[100%] lg:w-[30%] pt-4 bg-cover sacar lg:h-full ' + (escondido ? ' hidden w-[0]' : '')} style={{ backgroundImage: `url(${bgBanner})` }}>
            ...
            <div className=''>
                ...
                <h2 className='text-white mb-2  font-bold text-2xl lg:text-base'>Escribe la tarea</h2>
                <input type="text" value={tarea} onChange={(e) => setTarea(e.target.value)} class={"bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2 w-[60%] lg:w-[85%] mx-auto lg:mb-4 mb-4 lg:mb-2  " + (advertir && "border-red-600 border-4 animate-bounce  ")} />
                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <button onClick={(e) => {
                        ...
                        className={"text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-[25%] lg:w-[40%] mb-6 lg:mb-4"}>Crear</button>
